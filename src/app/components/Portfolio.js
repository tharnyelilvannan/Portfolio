...
export default function Portfolio() {
    return (
        <motion.button
            ...
            <p className='lg:text-[1rem] sm:text-[0.8rem]'>It's what you're looking at right now! Created with React, TailwindCSS and Next.js, and deployed with Vercel. It is a work in progress!</p><br></br>
